...
class SubscriptiontypeController extends Controller
{
    ...
    {
        return view('admin.subs.subscriptiontype.index')
    ...
    public function store(Request $request)
    {
        ...
        if($validator->fails()){
            return redirect()
                ->route('admin.subs.subscriptiontype.create')
        ...
        return redirect()->route('admin.subs.subscriptiontype.index');
    }
    ...
    {
        return view('admin.subs.subscriptiontype.view')
            ->with('dates', self::dates())
