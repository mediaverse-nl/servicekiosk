...
@section('content')
    ...
    <div id="fullpage">
        ...
        <div class="section section-three">
            ...
            <a href="#secondSection"><img class="pijltje_next" src="/image/img-touch/pijltje_page_down.png" ></a>
        </div>
        ...
        <div class="section section-two">
            <div class="slide slide-one">
                ...
                <a href="#thirdSection"><img class="pijltje_next" src="/image/img-touch/pijltje_page_down.png" ></a>
            </div>
        ...
        <div class="section section-two">
            ...
            <a href="#fourthSection"><img class="pijltje_next" src="/image/img-touch/pijltje_page_down.png" ></a>
        </div>
        ...
        <div class="section section-two">
            <div id="usp">
                <div class="slide slide-one">
                    ...
                    <div id="usp1">
                        <div class="tekst_usp">
                            <p>Onze software wordt lokaal geprogrammeerd. Wanneer er updates moeten en er ergens in het proces iets mis gaat bij u, of wanneer er gewoon iets fout is gegaan, kunt u direct contact op nemen met onze helpdesk. Bij ernstige errors in uw systeem kan een medewerker eventueel bij u langskomen om alles weer op orde te brengen.
                                Verder werken wij ook met lokale staalbedrijven en elektronica bedrijven die onze hardware leveren. Dus ook bij eventuele fouten op dat gebied, kunnen problemen snel verholpen worden.
                                Dat is het voordeel van lokale productie.
                            </p>
                        </div>
                    </div>
                    <a href="#fifthSection"><img class="pijltje_next" src="/image/img-touch/pijltje_page_down.png" ></a>
                </div>

                <div class="slide slide-two">
                    <h1>Maatwerk software</h1>
                    <div id="usp1">
                        <div class="tekst_usp">
        ...
        <div class="section section-two">
            <div id="branches">
                <div class="slide slide-one">
                    ...
                    <a href="#sixthSection"><img class="pijltje_next" src="/image/img-touch/pijltje_page_down.png" ></a>
                </div>
        ...
        <div class="section section-three">
            <div id="kleuren" class="center-text">
            <h1>Kleuren</h1>
                <div class="row">
                <div class="col-md-6">
            <iframe name="ContentFrame" src="/image/img-touch/kleuren/geen_kleur2.png" style="margin:auto;">
            </iframe>
            </br>
                </div>
            ...
            <a href="/image/img-touch/kleuren/donker_rood.png" target="ContentFrame"><img src="/image/img-touch/kleuren/rood_button.png"></a>
            <a href="/image/img-touch/kleuren/oranje.png" target="ContentFrame"><img src="/image/img-touch/kleuren/oranje_button.png"></a>
            <a href="/image/img-touch/kleuren/geel.png" target="ContentFrame"><img src="/image/img-touch/kleuren/geel_button.png"></a>
            <a href="/image/img-touch/kleuren/wit.png" target="ContentFrame"><img src="/image/img-touch/kleuren/wit_button.png"></a></br>
            <a href="/image/img-touch/kleuren/geen_kleur2.png" target="ContentFrame"><img src="/image/img-touch/kleuren/grijs_button.png"></a>
            <a href="/image/img-touch/kleuren/groen.png" target="ContentFrame"><img src="/image/img-touch/kleuren/groen_button.png"></a>
            <a href="/image/img-touch/kleuren/paars.png" target="ContentFrame"><img src="/image/img-touch/kleuren/paars_button.png"></a>
            <a href="/image/img-touch/kleuren/blauw.png" target="ContentFrame"><img src="/image/img-touch/kleuren/blauw_button.png"></a>
                    </div>
                </div>
            <a href="#seventhSection"><img class="pijltje_next block-center" src="/image/img-touch/pijltje_page_down.png" ></a>
        ...
        <div class="section section-three">
                ...
                <h1>Testimonials</h1>
                <img src="/image/img-touch/testemonials_logo_prim.png">
                <div id="tekstvlak_test">
                    ...
                    <a href="#eighthSection"><img class="pijltje_next" src="/image/img-touch/pijltje_page_down.png" ></a>
                </div>
        ...
        <div class="section section-three">
            ...
            <aside>
                ...
                <div id="form_mailinglist">
                    ...
                    <form action="/action_page.php">
                        ...
                        <label for="email"><p>email adres:</p></label></br>
                        <input type="text" id="email" name="email" placeholder="email adres"></br>
            ...
            <a href="#ninethSection"><img class="pijltje_next" src="/image/img-touch/pijltje_page_down.png" ></a>
        </div>
